...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='../modelzoo/YOLOmodels/yolov5s.pt', help='initial weights path')#yolov5l.pt yolov5s.pt
    parser.add_argument('--cfg', type=str, default='models/yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/HPCcoco.yaml', help='dataset.yaml path')
